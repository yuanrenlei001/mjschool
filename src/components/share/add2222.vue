        ...
        <div v-show="radio == 'article'" id="imgUploader">
            <div class="file-list">
                ...
                <div class="thumbnails my-gallery">
                    <div  itemprop="associatedMedia" itemscope  class="thumbnail figure" v-for="(item,index) in files" :key="index" :id="item.Id">
...
<!--                        <div class="pswp__item"></div>-->
<!--                    </div>-->
<!--                    &lt;!&ndash; 预览区域顶部的默认UI，可以修改 &ndash;&gt;-->
<!--                    <div class="pswp__ui pswp__ui&#45;&#45;hidden">-->
<!--                        <div class="pswp__top-bar">-->
<!--                            &lt;!&ndash;  与图片相关的操作 &ndash;&gt;-->
<!--                            <div class="pswp__counter"></div>-->
<!--                            <button class="pswp__button pswp__button&#45;&#45;close" title="Close (Esc)"></button>-->
<!--                            &lt;!&ndash;将分享按钮去掉 &ndash;&gt;-->
<!--                            &lt;!&ndash; <button class="pswp__button pswp__button&#45;&#45;share" title="Share"></button>-->
