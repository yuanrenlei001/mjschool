    ...
    <div class="container" style="background: #f0f1f7;">
        ...
        <div class="main">
            ...
            <div class="share" style="left:0;">
                <p>{{userScore.learn_score}}</p>
                <p>个人所有积分</p>
            </div>
            <div class="share" style="right:0;">
                <p>{{userScore.learn_sort}}</p>
                <p>个人积分排名</p>
            </div>
            <span></span>
        </div>
        ...
        <div class="fixed" v-show="show">
            <div class="fixedMain" id="bottoms">
                ...
                <!--<div><span class="title03">公司三星讲师</span><span class="title02">400积分/次</span></div>-->
                <!--<div><span class="title03">公司二星讲师</span><span class="title02">400积分/次</span></div>-->
        ...
        methods:{
            ...
            getScore:function(){
                ...
                this.axios({
                    ...
                    url: this.getAjax+'/score/learn?month='+this.value2,    // 访问的后端接口地址
            ...
            typess:function(e){
                ...
                this.axios({
                    type: 'get',     // 通过设置type，来选择是get还是post请求
                    url: this.getAjax+'/score/learn?month='+this.types,    // 访问的后端接口地址
                    // url: this.getAjax+'/newsRotatePic.do',    // 访问的后端接口地址
                    params: {                // get请求使用params,post请求使用data(data为json格式)
...
<style scoped>
    ...
    .fixedMain {width:5.8rem;height:4.45rem;position: relative;margin: 50% auto 0;
        background: url(../../assets/img/integral/integral06.png) no-repeat;
        background-size: 5.8rem 4.45rem;padding-left: .3rem;
    }
