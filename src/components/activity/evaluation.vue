...
<style scoped>
    ...
    .control-label {position: absolute;right:2rem;color: #f4a409;font-size: .28rem;top:-.08rem;}
    .col-md-8 {width:60%;margin: auto;position: relative;font-size: .24rem;}
    .control-labels {position: absolute;left:0;font-size: .28rem;color: #4c4c4c;top:-.08rem;}
